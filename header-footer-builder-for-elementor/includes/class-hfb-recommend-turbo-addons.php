                ...
                <div style="width:70%; flex:1; display:flex; flex-direction:column; justify-content:center;">
                    ...
                    <p style="margin:0 0 12px 0;">
                        <strong style="color:#ff9a00; font-size:20px; line-height:1.4;">
                            <?php esc_html_e( 'Build Complete Websites in Minutes — Get 200+ Templates (Single + Full Website) at Discount', 'header-footer-builder-for-elementor' ); ?>
                        </strong>
                    </p>

                    <p style="margin:0 0 15px 0; font-size:14px; line-height:1.6; color:#444;">
                        <?php esc_html_e(
                            'You just installed Header Footer Builder. Now take it further. Get Turbo Addons — 200+ premium templates (single pages + ready-made full websites). Import and launch in 1 click. No coding. No stress.🔥 Special discount for you — Limited time only!',
                   ...
                   <a href="<?php echo esc_url( 'https://turbo-addons.com/templates/' ); ?>" 
                        ...
                        <?php esc_html_e( 'Claim Discount — Get All 200+ Templates', 'header-footer-builder-for-elementor' ); ?>
                    </a>
                   </div>
                </div>
